...
<body>
    ...
    <main>
        ...
        <p>fasilitas: <?= $data[0]['fasilitas'] ?></p>
...
<body>
  ...
  <div class="card">
    <h1>Kamar Tipe A</h1>
    <p class="description">
      Nikmati kenyamanan tidur yang luar biasa di kamar kami dengan kasur queen size yang luas. Dirancang untuk memberikan pengalaman menginap yang relaks dan menyegarkan, kamar ini cocok untuk pasangan atau tamu yang menginginkan kenyamanan ekstra.
    </p>
    ...
    <div class="facilities">
      ...
      <ul>
        ...
        <li>Kamar Mandi Dalam + Shower Air Panas</li>
